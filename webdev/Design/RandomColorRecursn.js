//console.log("Welcome");
function RandomColouredWelcomeAutoRefresh()
{
...
document.write("<h2>Refreshed</h2>");
setTimeout(RandomColouredWelcomeAutoRefresh,5000);

}

RandomColouredWelcomeAutoRefresh();
